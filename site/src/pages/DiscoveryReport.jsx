...
export const DiscoveryReport = ({}) => {
  ...
  return (
    <Layout title="Aktiviteter">
      <div className="h-50 mx-auto mb-4 flex w-80 max-w-[425px] rounded-lg border bg-gray-800 shadow-lg hover:shadow-xl dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
