          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="mb-2 flex flex-col">
              <div className="relative">
                <h1 className="text-purple-300">Angiv adressen hvor cyklen er fundet eller tryk på "Find min lokation"
                <span className="required-dot text-red-500"> *</span>
                </h1>
                <input
                  className="w-full flex-1 py-2 px-4 appearance-none rounded-lg border border-gray-300 bg-white text-base text-gray-700 placeholder-gray-400 shadow-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600"
                  type="text"
                  placeholder="Vejnavn Nummer, Postnummer By"
                  {...register("address", { required: true})}
                  />
                  {errors.address && <span className="text-red-300">This field is required</span>}
                {/* <input
                  type="text"
            ...
            <label className="text-purple-300" htmlFor="name">Eventuel kommentar
              </label>
              <textarea
                className="w-full flex-1 px-4 py-2 appearance-none rounded-lg border border-gray-300 bg-white text-base text-gray-700 placeholder-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600"
                id="comment"
