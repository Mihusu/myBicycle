...
const ViewTransferAccept = () => {
    ...
    const { data, error, isLoading } = useSWR([API_URL + '/bikes/me', token], ([url, token]) => get_bike_request(url, token))
    ...
    async function approveBikeRequest() {
        ...
        const approve_bike_request = (API_URL + `/transfers/${data._id}/approve`)
